...
const About = () => {
    ...
    const galleryImages = [
        ...
        },
        {
            ...
            caption: 'Best Use of Technology award, Western Engineering Junior Design Competition 2023'
        }
    ];
    ...
    return (
        ...
        I&apos;m a software engineering graduate from Western University (Dean&apos;s Honour List). Most recently,
        ...
        <p>
        I&apos;ve built my technical foundation through coursework in Algorithms, Operating Systems, Databases, and
        Web Technologies. From a capstone platform deployed department-wide to freelance client work to a
        full roguelike built from scratch, I take projects through the full lifecycle (concept, development,
                                                                                       and deployment) with a focus on shipping software people actually use.
                                                                                           </p>
                                                                                       </div>
                                                                                       </div>
                                                                                       ...
                                                                                       <span className="text-gray-300 text-sm">Software Engineering graduate from Western University (Dean&apos;s Honour List)</span>
                                                                                       </li>
                                                                                       <li className="flex items-start">
                                                                                       <span className="flex-shrink-0 p-0.5 bg-finlayGreen rounded-full mr-2 mt-1.5">
                                                                                       <svg className="w-2.5 h-2.5 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
